...
> 추구하는 컨벤션은 ['profile/karpathy-guidelines.mdc'](https://github.com/mineni-korea/.github/blob/main/profile/karpathy-guidelines.mdc)에 있으니,  
...
-   **기능 추가, 버그 수정, 리팩토링을 섞지 않는다. 대거의 스타일 수정 커밋 (린트 적용)은 별도 PR로 처리한다.**
